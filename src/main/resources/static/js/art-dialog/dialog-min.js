    ...
    b("popup", function(a) {
        ...
        return c.extend(b.prototype, {
            ...
            show: function(a) {
                ...
                !this.__ready) {
                    if (d.addClass(this.className).attr("role", this.modal ? "alertdialog" : "dialog").css("position", this.fixed ? "fixed" : "absolute"),
            ...
            __follow: function(a) {
                var b = a.parentNode && c(a)
                  , d = this.__popup;
                if (this.__followSkin && d.removeClass(this.__followSkin),
                b) {
                    var e = b.offset();
                    if (e.left * e.top < 0)
        ...
        b.zIndex=9999, b.current = null ,  b
    }
    ),
    b("dialog-config", {
        background: "#000",
        ...
        innerHTML: '<div i="dialog" class="art-ui-dialog"><div class="art-ui-dialog-arrow-a"></div><div class="art-ui-dialog-arrow-b"></div><table class="art-ui-dialog-grid"><tr><td i="header" class="art-ui-dialog-header"><button i="close" class="art-ui-dialog-close">&#215;</button><div i="title" class="art-ui-dialog-title"></div></td></tr><tr><td i="body" class="art-ui-dialog-body"><div i="content" class="art-ui-dialog-content"></div></td></tr><tr><td i="footer" class="art-ui-dialog-footer"><div i="statusbar" class="art-ui-dialog-statusbar"></div><div i="button" class="art-ui-dialog-button"></div></td></tr></table></div>'
    }),
    b("dialog", function(a) {
        var b = a("jquery")
          , c = a("popup")
        ...
        var g = 0
          ...
          , l = function(a, c, d) {
            ...
            var f = a.id = a.id || h + g
              , i = l.get(f);
            return i ? i.focus() : (k || (a.fixed = !1),
            a.quickClose && (a.modal = !0,
            a.backdropOpacity = 0),
        ...
        return l.create = function(a) {
            ...
            a.quickClose && f.on("onmousedown" in document ? "mousedown" : "click", function() {
        ...
        b.extend(n, {
            ...
            button: function(a) {
                ...
                e++) : b.each(a, function(a, f) {
                    ...
                    d += '<button type="button" i-id="' + g + '"' + h + (f.disabled ? " disabled" : "") + (f.autofocus ? ' autofocus class="art-ui-dialog-autofocus"' : "") + ">" + f.value + "</button>",
