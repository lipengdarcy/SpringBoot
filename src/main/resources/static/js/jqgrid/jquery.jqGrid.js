	...
	styleUI : {
		jQueryUI : {
			...
			base : {
				...
				icon_first : "icon-double-angle-left bigger-140",
				icon_prev : "icon-angle-left bigger-140",
				icon_next: "icon-angle-right bigger-140",
				icon_end: "icon-double-angle-right bigger-140",
			...
			inlinedit : {
				...
				icon_add_nav : "icon-chevron-right",
				icon_save_nav : "icon-ok",
				icon_cancel_nav : "icon-remove"
			},
			formedit : {
				inputClass : "ui-widget-content ui-corner-all",
				icon_prev : "icon-chevron-left",
				icon_next : "icon-chevron-right",
				icon_save : "icon-ok",
			...
			navigator : {
				icon_edit_nav : "icon-pencil",             //缂栬緫灏忓浘鏍�
				icon_add_nav : "icon-plus-sign",         //鏂板灏忓浘鏍�
				icon_del_nav : "icon-trash",                //鍒犻櫎灏忓浘鏍�
				icon_search_nav : "icon-search",         //鎼滅储灏忓浘鏍�
				icon_refresh_nav : "icon-refresh",        //鍒锋柊灏忓浘鏍�
				icon_view_nav : "icon-zoom-in",            //鏌ョ湅灏忓浘鏍�
			...
			filter : {
				...
				icon_reset : 'icon-retweet',
				icon_query :'ui-icon-comment'
			},
			subgrid : {
				icon_plus : 'icon-chevron-right',
				icon_minus : 'icon-chevron-down',
		...
		Bootstrap : {
			...
			base : {
				...
				pgButtonBox : "",
				icon_first : "icon-double-angle-left bigger-140", //棣栭〉
				icon_prev : "icon-angle-left bigger-140",         //涓婁竴椤�
				icon_next: "icon-angle-right bigger-140",         //涓嬩竴椤�
				icon_end: "icon-double-angle-right bigger-140",   //灏鹃〉
			...
			modal : {
				...
				resizable : "ui-resizable-handle ui-resizable-se",
				icon_close : "ui-icon-closethick",
				icon_resizable : "icon-resize-horizontal"
			},
			celledit : {
			...
			grouping : {
				icon_plus : 'icon-chevron-right',    //澶氱骇琛ㄦ牸鍙虫寜閽�
				icon_minus : 'icon-chevron-down'     //澶氱骇琛ㄦ牸涓嬫寜閽�
			},
			filter : {
			...
			fmatter : {
				icon_edit : "icon-pencil",
				icon_add : "icon-plus-sign",
				icon_save : "icon-ok-sign blue",
				icon_cancel : "icon-remove-sign orange",
				icon_del : "icon-trash"
			},
			colmenu : {
				menu_widget : '',
...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		var p = $.extend(true,{
			...
			cellsubmit: "remote",
			nv:0,
			loadui: "enable",//原为enable  显示加载ul  现在改为Disable  不显示加载ul  edit by yanglei
			toolbar: [false,""],
			scroll: false,
			multiboxonly : false,
		...
		$(ts).before(grid.hDiv).on({
			...
			'reloadGrid': function(e,opts) {
				...
				//防止删除至只剩第一页之后  无法翻页  edit by yanglei 
				setTimeout(function() {
					if (ts.p.lastpage <ts.p.page&&count==0) {
						var page=ts.p.lastpage;
						//防止没有数据的时候新增第一条无法显示
						if(page==0){
							page=1;
						}
						//防止搜索时page比lastpage大  一直刷新
						count=page;
						$(ts).jqGrid('setGridParam', {
							page:page
						}).trigger("reloadGrid");// 重新载入
					}else{
						//防止第二次输入搜索条件不存在时 无法进入这个定时器  导致页码出错
						count=0;
					}
		...
		return this.each(function(){
			...
			if(fr !== null) {
				...
				switch (cm.edittype) {
					...
					case "pesmen":
						try {
							if(cm.editoptions && $.isFunction(cm.editoptions.pesmen_value)) {
								v = cm.editoptions.pesmen_value.call($t, $(".pesmenelement",cc),'get');
								if (v===undefined) { throw "e2";} else { v2=v; }
							} else { throw "e1"; }
						} catch (e) {
							if (e==="e1") { $.jgrid.info_dialog(errors.errcap, "function 'pesmen_value' " + edit.msg.nodefined, edit.bClose, {styleUI : $t.p.styleUI }); }
							else if (e==="e2") { $.jgrid.info_dialog(errors.errcap, "function 'pesmen_value' " + edit.msg.novalue, edit.bClose, {styleUI : $t.p.styleUI }); }
							else {$.jgrid.info_dialog(errors.errcap, e.message, edit.bClose, {styleUI : $t.p.styleUI }); }
						}
						break;
					case "multiselect":
						try {
							if(cm.editoptions && $.isFunction(cm.editoptions.multiselect_value)) {
								v = cm.editoptions.multiselect_value.call($t, $(".multiselectelement",cc),'get');
								if (v===undefined) { throw "e2";} else { v2=v; }
							} else { throw "e1"; }
						} catch (e) {
							if (e==="e1") { $.jgrid.info_dialog(errors.errcap, "function 'multiselect_value' " + edit.msg.nodefined, edit.bClose, {styleUI : $t.p.styleUI }); }
							else if (e==="e2") { $.jgrid.info_dialog(errors.errcap, "function 'multiselect_value' " + edit.msg.novalue, edit.bClose, {styleUI : $t.p.styleUI }); }
							else {$.jgrid.info_dialog(errors.errcap, e.message, edit.bClose, {styleUI : $t.p.styleUI }); }
						}
						break;
					case "upfile":
						try {
							if(cm.editoptions && $.isFunction(cm.editoptions.file_value)) {
								v = cm.editoptions.file_value.call($t, $(".upfileelement",cc),'get');
								if (v===undefined) { throw "e2";} else { v2=v; }
							} else { throw "e1"; }
						} catch (e) {
							if (e==="e1") { $.jgrid.info_dialog(errors.errcap, "function 'upfile_value' " + edit.msg.nodefined, edit.bClose, {styleUI : $t.p.styleUI }); }
							else if (e==="e2") { $.jgrid.info_dialog(errors.errcap, "function 'upfile_value' " + edit.msg.novalue, edit.bClose, {styleUI : $t.p.styleUI }); }
							else {$.jgrid.info_dialog(errors.errcap, e.message, edit.bClose, {styleUI : $t.p.styleUI }); }
						}
						break;
				}
...
//Helper functions
	...
	viewModal : function (selector,o){
		o = $.extend({
			...
			overlay: 10,
			modal: false,
			overlayClass : 'ui-widget-overlay', // 鍥哄畾鐨�
	...
	info_dialog : function(caption, content,c_b, modalopt) {
		...
		// 濡傛灉涓嶆彁渚沬d锛屾垜灏辨妸瀹�info_button_+ 绱㈠紩鏁扮粍涓�- i.e info_button_0,info_button_1...
		};
...
// 琛ㄥ崟鍔熻兘
	createEl : function(eltype,options,vl,autowidth, ajaxso) {
		...
		switch (eltype)
		{
			...
			break;
			case "checkbox" : //浠�箞鏄唬鐮佺畝鍗曠殑澶嶉�妗�
						...
						success: function(data){
							...
							if(a) {
								...
								$("option",elem).each(function(i){
									...
									// 淇IE8 / IE7閫夋嫨绗竴椤圭殑闂 multiple=true
			...
			case "pesmen" :
				...
				try {
					if($.isFunction(options.pesmen_element)) {
						var celm = options.pesmen_element.call($t,vl,options);
						if(celm) {
							celm = $(celm).addClass("pesmenelement").attr({id:options.id,name:options.name});
							$(elem).empty().append(celm);
						} else {
							throw "e2";
						}
					...
					if (e==="e1") { $.jgrid.info_dialog(errors.errcap,"function 'pesmen_element' "+edit.msg.nodefined, edit.bClose, {styleUI : $t.p.styleUI });}
					else if (e==="e2") { $.jgrid.info_dialog(errors.errcap,"function 'pesmen_element' "+edit.msg.novalue,edit.bClose, {styleUI : $t.p.styleUI });}
					else { $.jgrid.info_dialog(errors.errcap,typeof e==="string"?e:e.message,edit.bClose, {styleUI : $t.p.styleUI }); }
				}
			break;
			case "multiselect" :
				elem = document.createElement("div");
				try {
					if($.isFunction(options.multiselect_element)) {
						var celm = options.multiselect_element.call($t,vl,options);
						if(celm) {
							celm = $(celm).addClass("multiselectelement").attr({id:options.id,name:options.name});
							$(elem).empty().append(celm);
						} else {
							throw "e2";
						}
					...
					if (e==="e1") { $.jgrid.info_dialog(errors.errcap,"function 'multiselect_element' "+edit.msg.nodefined, edit.bClose, {styleUI : $t.p.styleUI });}
					else if (e==="e2") { $.jgrid.info_dialog(errors.errcap,"function 'multiselect_element' "+edit.msg.novalue,edit.bClose, {styleUI : $t.p.styleUI });}
					else { $.jgrid.info_dialog(errors.errcap,typeof e==="string"?e:e.message,edit.bClose, {styleUI : $t.p.styleUI }); }
				}
			break;
			case "upfile" :
				elem = document.createElement("div");
				try {
					if($.isFunction(options.upfile_element)) {
						var celm = options.upfile_element.call($t,vl,options);
						if(celm) {
							celm = $(celm).addClass("upfileelement").attr({id:options.id,name:options.name});
							$(elem).empty().append(celm);
						} else {
							throw "e2";
						}
					...
					if (e==="e1") { $.jgrid.info_dialog(errors.errcap,"function 'upfile_element' "+edit.msg.nodefined, edit.bClose, {styleUI : $t.p.styleUI });}
					else if (e==="e2") { $.jgrid.info_dialog(errors.errcap,"function 'upfile_element' "+edit.msg.novalue,edit.bClose, {styleUI : $t.p.styleUI });}
					else { $.jgrid.info_dialog(errors.errcap,typeof e==="string"?e:e.message,edit.bClose, {styleUI : $t.p.styleUI }); }
				}
			break;
			default :
...
// 鏃ユ湡楠岃瘉鐨凧avascript
	checkDate : function (format, date) {
		...
		// 2鏈堟湁29澶╀换浣曚竴骞撮兘涓嶈兘琚洓鏁撮櫎,闄や竴涓栫邯鐨勫勾涓嶄篃鑳借400鏁撮櫎
		...
		*/
		...
		this.createTableForGroup = function(group, parentgroup) {
			...
			inputAddRule.on('click',function() {
				...
				// 鍙樉绀簊erchable鍜宻erchhidden = true瀛楁
				...
				that.reDraw(); // html宸茬粡鏀瑰彉,鍔涢噸缁�
				// 鐩墠娌℃湁鏀瑰彉浜嗚鍒�鎵�互杩欎笉浼氳Е鍙憃nchange浜嬩欢
				return false;
			});
		...
		this.createTableRowForRule = function(rule, group ) {
			// 淇濆瓨褰撳墠瀹炰綋鍦ㄤ竴涓彉閲忎腑,浠ヤ究瀹冨彲浠ュ紩鐢╝nonimous鏂规硶璋冪敤
			...
			// dropdown for: choosing field 涓嬫媺閫夋嫨锛氶�鎷╁瓧娈�
			...
			cm = p.columns[j];
			// 鍦ㄨ繖閲屽垱寤�鍥犳瀹冨彲浠eferentiated onchange浜嬩欢
			...
			} //淇濈暀绂佺敤鐘舵�鐨勬枃鏈瓧娈电殑闆舵搷浣�
			// dropdown for: choosing operator 涓嬫媺閫夋嫨锛氶�鎷╄繍钀ュ晢
			...
			ruleOperatorSelect.on('change',function() {
				...
				if (rule.op === "nu" || rule.op === "nn") { // 绂佺敤鎿嶄綔绗︹�涓虹┖鈥濆拰鈥滀笉绌衡�
					rule.data = "";
			...
			ruleDeleteInput.on('click',function() {
				...
				that.reDraw(); // html宸茬粡鏀瑰彉浜嗭紝寮哄埗閲嶇粯
		...
		// 鍒涘缓Mark杩欐牱瀹冨皢涓嶄細鍒涘缓鍦ㄨ繖涓厓绱犵殑涓ゅ�
		this.filter = true;
	});
};
$.extend($.fn.jqFilter,{
				...
				$.each($t.p.colModel,function(){
					...
					switch (this.stype) {
						...
						case 'custom':
							...
							break;
						/*case 'pesmen':
							if ($.isFunction(this.searchoptions.pesmen_value) && $elem.length > 0 && $elem[0].nodeName.toUpperCase() === "SPAN") {
								this.searchoptions.pesmen_value.call($t, $elem.children(".pesmenelement:first"), "set", v || "");
							}
							break;
						case 'multiselect':
							if ($.isFunction(this.searchoptions.multiselect_value) && $elem.length > 0 && $elem[0].nodeName.toUpperCase() === "SPAN") {
								this.searchoptions.multiselect_value.call($t, $elem.children(".multiselectelement:first"), "set", v || "");
							}
							break;
						case 'file':
							if ($.isFunction(this.searchoptions.file_value) && $elem.length > 0 && $elem[0].nodeName.toUpperCase() === "SPAN") {
								this.searchoptions.file_value.call($t, $elem.children(".fileelement:first"), "set", v || "");
							}
							break;*/
					}
				});
	...
	searchGrid : function (p) {
		...
		return this.each(function() {
			...
			if ( $("#"+$.jgrid.jqID(IDs.themodal))[0] !== undefined ) {
				...
				var fil = $("<div><div id='"+fid+"' class='searchFilter' style=''></div></div>").insertBefore("#gview_"+$.jgrid.jqID($t.p.id)),
				align = "left", butleft =""; 
				if($t.p.direction === "rtl") {
					align = "right";
				...
				bS  ="<a id='"+fid+"_search' class='fm-button " + common.button + " fm-button-icon-right ui-search ui-state-default ui-corner-all btn btn-sm btn-purple'><span class='" + common.icon_base + " " +classes.icon_search + "'></span>"+p.Find+"</a>",
				bC  ="<a id='"+fid+"_reset' class='fm-button " + common.button +" fm-button-icon-left ui-reset ui-state-default ui-corner-all btn btn-sm btn-info'><span class='" + common.icon_base + " " +classes.icon_reset + "'></span>"+p.Reset+"</a>",
...
$.jgrid.extend({
	...
	editGridRow : function(rowid, p){
		...
		return this.each(function(){
			...
			function fillData(rowid,obj,fmid){
				...
				$('td[role="gridcell"]',tre).each( function(i) {
					...
					if ( nm !== 'cb' && nm !== 'subgrid' && nm !== 'rn' && cm[i].editable===true) {
						...
						nm = $.jgrid.jqID(nm);
						switch (cm[i].edittype) {   //edittype灞炴�
							case "password":
							case "text":
							case "button" :
							case "image":
							...
							/*case 'pesmen' :
								try {
									if(cm[i].editoptions && $.isFunction(cm[i].editoptions.pesmen_value)) {
										cm[i].editoptions.pesmen_value.call($t, $("#"+nm, fmid),'set',tmp);
									} else {throw "e1";}
								} catch (e) {
									if (e==="e1") {$.jgrid.info_dialog(errors.errcap,"function 'pesmen_value' "+rp_ge[$(this)[0]].p.msg.nodefined,$.rp_ge[$(this)[0]].p.bClose, {styleUI : rp_ge[$(this)[0]].p.styleUI });}
									else {$.jgrid.info_dialog(errors.errcap,e.message,$.rp_ge[$(this)[0]].p.bClose, {styleUI : rp_ge[$(this)[0]].p.styleUI });}
								}
								break;
							case 'multiselect' :
								try {
									if(cm[i].editoptions && $.isFunction(cm[i].editoptions.multiselect_value)) {
										cm[i].editoptions.multiselect_value.call($t, $("#"+nm, fmid),'set',tmp);
									} else {throw "e1";}
								} catch (e) {
									if (e==="e1") {$.jgrid.info_dialog(errors.errcap,"function 'multiselect_value' "+rp_ge[$(this)[0]].p.msg.nodefined,$.rp_ge[$(this)[0]].p.bClose, {styleUI : rp_ge[$(this)[0]].p.styleUI });}
									else {$.jgrid.info_dialog(errors.errcap,e.message,$.rp_ge[$(this)[0]].p.bClose, {styleUI : rp_ge[$(this)[0]].p.styleUI });}
								}
								break;
							case 'file' :
								try {
									if(cm[i].editoptions && $.isFunction(cm[i].editoptions.file_value)) {
										cm[i].editoptions.file_value.call($t, $("#"+nm, fmid),'set',tmp);
									} else {throw "e1";}
								} catch (e) {
									if (e==="e1") {$.jgrid.info_dialog(errors.errcap,"function 'file_value' "+rp_ge[$(this)[0]].p.msg.nodefined,$.rp_ge[$(this)[0]].p.bClose, {styleUI : rp_ge[$(this)[0]].p.styleUI });}
									else {$.jgrid.info_dialog(errors.errcap,e.message,$.rp_ge[$(this)[0]].p.bClose, {styleUI : rp_ge[$(this)[0]].p.styleUI });}
								}
								break;*/
						}
			...
			bp = rtlb ? "nData" : "pData",
			bn = rtlb ? "pData" : "nData";
			var bP = "<a id='"+bp+"' class='fm-button ui-state-default ui-corner-left " + commonstyle.button + "'><span class='" + commonstyle.icon_base + " " + styles.icon_prev+ "'></span></a>",
			bN = "<a id='"+bn+"' class='fm-button ui-state-default ui-corner-right " + commonstyle.button + "'><span class='" + commonstyle.icon_base + " " + styles.icon_next+ "'></span></a>",
			bS  ="<a id='sData' class='fm-button ui-state-default ui-corner-all btn-sm btn-primary " + commonstyle.button + "'>"+p.bSubmit+"</a>",
			bC  ="<a id='cData' class='fm-button ui-state-default ui-corner-all btn-sm " + commonstyle.button + "'>"+p.bCancel+"</a>";
			var bt = "<table style='height:auto' class='EditTable ui-common-table' id='"+frmtborg+"_2'><tbody><tr><td colspan='2'><hr class='"+commonstyle.content+"' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton' style='display:none'>"+(rtlb ? bN+bP : bP+bN)+"</td><td class='EditButton'>"+bS+bC+"</td></tr>";
			...
			if(rp_ge[$t.p.id].checkOnSubmit || rp_ge[$t.p.id].checkOnUpdate) {
				bS  ="<a id='sNew' class='fm-button btn-xs "+commonstyle.button + "' style='z-index:1002'>"+p.bYes+"</a>";
				bN  ="<a id='nNew' class='fm-button btn-xs "+commonstyle.button + "' style='z-index:1002;margin-left:5px'>"+p.bNo+"</a>";
				bC  ="<a id='cNew' class='fm-button btn-xs "+commonstyle.button + "' style='z-index:1002;margin-left:5px;'>"+p.bExit+"</a>";
	...
	viewGridRow : function(rowid, p){
		...
		return this.each(function(){
			...
			p.gbox = "#gbox_"+$.jgrid.jqID(gID);
			var bt = $("<div></div>").append(frm).append("<table border='0' class='EditTable' id='"+frmtb+"_2'><tbody><tr id='Act_Buttons'><td class='navButton' style='display:none' width='"+p.labelswidth+"'>"+(rtlb ? bN+bP : bP+bN)+"</td><td class='EditButton'>"+bC+"</td></tr></tbody></table>");
	...
	delGridRow : function(rowids,p) {
		...
		return this.each(function(){
			...
			if ( $("#"+$.jgrid.jqID(IDs.themodal))[0] !== undefined ) {
				...
				// buttons at footer
				tbl += "</tbody></table></div>";
				var bS  = "<a id='dData' class='fm-button " + commonstyle.button + "ui-state-default ui-corner-all btn btn-sm btn-danger'>"+p.bSubmit+"</a>",
				bC  = "<a id='eData' class='fm-button " + commonstyle.button + "ui-state-default ui-corner-all btn btn-sm'>"+p.bCancel+"</a>";
	...
	navGrid : function (elem, p, pEdit, pAdd, pDel, pSearch, pView) {
		...
		return this.each(function() {
			...
			for(i = 0; i<clone; i++) {
				...
				pAdd = pAdd || {};//鏂板
				if (o.add) {
					tbd = $("<td class='ui-pg-button ui-corner-all"+commonstyle.cornerall+"'></td>");
					$(tbd).append("<div class='ui-pg-div'><a href='javascript:;' class='btn btn-purple btn-xs'><span class='"+commonstyle.icon_base +" " +o.addicon+"'></span>"+o.addtext + "新增" +"</a></div>");
					$("tr",navtbl).append(tbd);
					$(tbd,navtbl)
					.attr({"data-original-title":o.addtitle || "",id : pAdd.id || "add_"+elemids})
					.click(function(){
						if (!$(this).hasClass( commonstyle.disabled )) {
				...
				if (o.edit) {
					tbd = $("<td class='ui-pg-button ui-corner-all"+commonstyle.cornerall+"'></td>");
					$(tbd).append("<div class='ui-pg-div'><a href='javascript:;' class='btn btn-primary btn-xs'><span class='"+commonstyle.icon_base+" "+o.editicon+"'></span>" +o.edittext+ "编辑" +"</a></div>");
					$("tr",navtbl).append(tbd);
					$(tbd,navtbl)
					.attr({"data-original-title":o.edittitle || "",id: pEdit.id || "edit_"+elemids})
					.click(function(){
						if (!$(this).hasClass( commonstyle.disabled )) {
							var sr = $t.p.selrow;
							if (sr) {
				...
				if (o.view) {
					tbd = $("<td class='ui-pg-button ui-corner-all"+commonstyle.cornerall+"'></td>");
					$(tbd).append("<div class='ui-pg-div'><a href='javascript:;' class='btn btn-xs'><span class='"+commonstyle.icon_base+" "+o.viewicon+"'></span>"+o.viewtext+ "查看" +"</a></div>");
					$("tr",navtbl).append(tbd);
					$(tbd,navtbl)
					.attr({"data-original-title":o.viewtitle || "",id: pView.id || "view_"+elemids})
					.click(function(){
						if (!$(this).hasClass( commonstyle.disabled )) {
							var sr = $t.p.selrow;
							if (sr) {
				...
				if (o.del) {
					tbd = $("<td class='ui-pg-button ui-corner-all"+commonstyle.cornerall+"'></td>");
					$(tbd).append("<div class='ui-pg-div'><a href='javascript:;' class='btn btn-danger btn-xs'><span class='"+commonstyle.icon_base+" "+o.delicon+"'></span>"+o.deltext+ "删除" +"</a></div>");
					$("tr",navtbl).append(tbd);
					$(tbd,navtbl)
					.attr({"data-original-title":o.deltitle || "",id: pDel.id || "del_"+elemids})
					.click(function(){
						if (!$(this).hasClass( commonstyle.disabled )) {
							var dr;
							if($t.p.multiselect) {
				...
				if(o.add || o.edit || o.del || o.view ) {$("tr",navtbl).append(sep);}//灏忓浘鏍囦腑闂寸殑鍒嗛殧绾�
				pSearch = pSearch || {};//鎼滅储
				if (o.search) {
					tbd = $("<td class='ui-pg-button ui-corner-all"+commonstyle.cornerall+"'></td>");
					$(tbd).append("<div class='ui-pg-div'><a href='javascript:;' class='btn btn-primary btn-xs'><span class='"+commonstyle.icon_base+" "+o.searchicon+"'></span>"+o.searchtext+ "搜索" +"</a></div>");
					$("tr",navtbl).append(tbd);
					$(tbd,navtbl)
					.attr({"data-original-title":o.searchtitle  || "",id:pSearch.id || "search_"+elemids})
					.click(function(){
						if (!$(this).hasClass( commonstyle.disabled )) {
				...
				if (o.refresh) {
					tbd = $("<td class='ui-pg-button ui-corner-all"+commonstyle.cornerall+"'></td>");
					$(tbd).append("<div class='ui-pg-div'><a href='javascript:;' class='btn btn-success btn-xs'><span class='"+commonstyle.icon_base+" "+o.refreshicon+"'></span>"+o.refreshtext+ "刷新" +"</a></div>");
					$("tr",navtbl).append(tbd);
					$(tbd,navtbl)
					.attr({"data-original-title":o.refreshtitle  || "",id: "refresh_"+elemids})
					.click(function(){
						if (!$(this).hasClass( commonstyle.disabled )) {
			...
			if($t.p.storeNavOptions) {
				$t.p.navOptions = o;
				$t.p.editOptions = pEdit;//缂栬緫
				$t.p.addOptions = pAdd;//鏂板
				$t.p.delOptions = pDel;//鍒犻櫎
				$t.p.searchOptions = pSearch;//鎼滅储
				$t.p.viewOptions = pView;//鏌ョ湅
				$t.p.navButtons =[];
			}
	...
	_buildNavMenu : function ( elem, elemids, p, pEdit, pAdd, pDel, pSearch, pView, pExpor ) {
		return this.each(function() {
			var $t = this,
				...
				if ( nm !== 'cb' && nm !== 'subgrid' && cm.editable===true && nm !== 'rn' && !$(this).hasClass('not-editable-cell')) {
					switch (cm.edittype) {
						...
						/*case 'pesmen' :
							try {
								if(cm.editoptions && $.isFunction(cm.editoptions.pesmen_value)) {
									tmp[nm] = cm.editoptions.pesmen_value.call($t, $(".pesmenelement",this),'get');
									if (tmp[nm] === undefined) { throw "e2"; }
								} else { throw "e1"; }
							} catch (e) {
								if (e==="e1") { $.jgrid.info_dialog(errors.errcap,"function 'pesmen_value' "+edit.msg.nodefined,edit.bClose, {styleUI : $t.p.styleUI }); }
						...
						case 'multiselect' :
							try {
								if(cm.editoptions && $.isFunction(cm.editoptions.multiselect_value)) {
									tmp[nm] = cm.editoptions.multiselect_value.call($t, $(".multiselectelement",this),'get');
									if (tmp[nm] === undefined) { throw "e2"; }
								} else { throw "e1"; }
							} catch (e) {
								if (e==="e1") { $.jgrid.info_dialog(errors.errcap,"function 'multiselect_value' "+edit.msg.nodefined,edit.bClose, {styleUI : $t.p.styleUI }); }
						...
						case 'file' :
							try {
								if(cm.editoptions && $.isFunction(cm.editoptions.file_value)) {
									tmp[nm] = cm.editoptions.file_value.call($t, $(".fileelement",this),'get');
									if (tmp[nm] === undefined) { throw "e2"; }
								} else { throw "e1"; }
							} catch (e) {
								if (e==="e1") { $.jgrid.info_dialog(errors.errcap,"function 'file_value' "+edit.msg.nodefined,edit.bClose, {styleUI : $t.p.styleUI }); }
								else { $.jgrid.info_dialog(errors.errcap,e.message,edit.bClose, {styleUI : $t.p.styleUI }); }
							}
							break;*/
					}
