...
@Configuration
@MapperScan(basePackages = "cn.smarthse.core.dao")
public class MybatisConfig {
	...
	public SqlSession sqlSession(SqlSessionFactory sf) throws Exception {
		log.info("step3：定义sqlSession");
		SqlSessionTemplate a = new SqlSessionTemplate(sf);
		return a;
	}
