...
public class Digests {
	...
	public static String sha1(String value, String salt){
		if(value==null) value="";
		if(salt==null) salt="";
 		byte[] hashPassword = Digests.sha1(value.getBytes(), salt.getBytes(), HASH_INTERATIONS);
		return Encodes.hexEncode(hashPassword);
	}
	...
	public static String salt(){
		return Encodes.hexEncode(Digests.generateSalt(SALT_SIZE));
	}
